...
**MAL-Sync** is a powerful extension and userscript, which enables automatic episode tracking between MyAnimeList/Anilist/Kitsu/Simkl/Shikimori/MangaBaka/Trakt and multiple anime streaming websites.

Makes it possible to use your MyAnimeList/Anilist/Kitsu/Simkl/Shikimori/MangaBaka/Trakt anime/mangalist as a centralized bookmarks system for all supported pages.
